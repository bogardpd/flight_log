...
class Map
  ...
  # # @see http://www.gcmap.com/ Great Circle Mapper
  # def gcmap
  #   return content_tag(:div, id: @id, class: ["map-gcmap", map_type]) do
  ...
  #     concat content_tag(:div, ActiveSupport::SafeBuffer.new + "Map generated by " + link_to("Great Circle Mapper", "http://www.gcmap.com/", target: "_blank"), class: %w(credit map-info))
  #   end
  # end
